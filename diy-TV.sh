...
sed -i '/private void parseJson/a\        PythonLoader.getInstance().setConfig(Prefers.getUrl(),object.toString());' $CURRENT_DIR/$DIR/app/src/main/java/com/fongmi/android/tv/api/ApiConfig.java
