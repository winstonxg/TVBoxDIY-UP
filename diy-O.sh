...
cd $DIR
#xwalk修复
sed -i 's/download.01.org\/crosswalk\/releases\/crosswalk\/android\/maven2/raw.githubusercontent.com\/lm317379829\/TVBoxDIY\/blob\/main/g' $CURRENT_DIR/$DIR/build.gradle
#名称修改
